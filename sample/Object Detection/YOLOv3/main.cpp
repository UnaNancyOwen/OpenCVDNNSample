...
int main( int argc, char* argv[] )
{
    ...
    // Read Darknet
    const std::string model   = "../yolov3.weights";
    const std::string config  = "../yolov3.cfg";
    ...
    */
    ...
    while( true ){
        ...
        cv::Mat blob = cv::dnn::blobFromImage( resize_frame, 1 / 255.f, cv::Size( 416, 416 ), cv::Scalar(), true, false );
